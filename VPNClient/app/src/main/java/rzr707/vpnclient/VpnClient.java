...
import static rzr707.vpnclient.ConnectionStatus.CONNECTION_FAILED;
import static rzr707.vpnclient.ConnectionStatus.CONNECT_SUCCESS;
import static rzr707.vpnclient.ConnectionStatus.DISCONNECT_SUCCESS;
import static rzr707.vpnclient.ConnectionStatus.TRY_CONNECT;
import static rzr707.vpnclient.CustomVpnService.SIGNAL_FAIL_CONNECT;
import static rzr707.vpnclient.CustomVpnService.SIGNAL_SERVICE_STOP;
import static rzr707.vpnclient.CustomVpnService.SIGNAL_SUCCESS_DISCONNECT;


public class VpnClient extends Activity {

    public static final String EXTRA_MESSAGE = "VpnClient.StartUp";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(rzr707.vpnclient.R.layout.form);

        // forbid landscape screen orientation:
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        serverSpinner   = findViewById(rzr707.vpnclient.R.id.serverSpinner);
        buttonImageView = findViewById(rzr707.vpnclient.R.id.buttonImageView);
        ...
        serverSpinnerAdapter = new ServerSpinnerAdapter<>(VpnClient.this,
                rzr707.vpnclient.R.layout.custom_spinner_object,
                countryList);
        ...
        buttonMenu = findViewById(rzr707.vpnclient.R.id.buttonMenu);
        buttonMenu.setOnClickListener(buttonMenuClickListener);

        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            AnimatedVectorDrawable drawable =
                    (AnimatedVectorDrawable) getDrawable(rzr707.vpnclient.R.drawable.unlocked_at_start);
    ...
    private void showPopupMenu(View v) {
        ...
        popupMenu.inflate(rzr707.vpnclient.R.menu.popupmenu);
                ...
                .setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case rzr707.vpnclient.R.id.menu1:
                                ...
                                return true;
                            case rzr707.vpnclient.R.id.menu2:
    ...
    public void startLockAnimation(ConnectionStatus lockType, ImageView view) {
        ...
        {
            case TRY_CONNECT:
                id = isLowerThanLollipop ? rzr707.vpnclient.R.drawable.orange_lock : rzr707.vpnclient.R.drawable.try_lock;
                break;
            case CONNECT_SUCCESS:
                id = isLowerThanLollipop ? rzr707.vpnclient.R.drawable.green_lock : rzr707.vpnclient.R.drawable.animated_lock;
                break;
            case DISCONNECT_SUCCESS:
                id = isLowerThanLollipop ? rzr707.vpnclient.R.drawable.lock : rzr707.vpnclient.R.drawable.animated_unlock;
                break;
            case CONNECTION_FAILED:
                id = isLowerThanLollipop ? rzr707.vpnclient.R.drawable.lock : rzr707.vpnclient.R.drawable.unlocked_at_start;
                break;
        }
    ...
    public class ServerSpinnerAdapter<T> extends ArrayAdapter<T> {
        ...
        public View getCustomView(int pos, View convertView, ViewGroup parent) {
            ...
            View layout = inflater.inflate(rzr707.vpnclient.R.layout.custom_spinner_object,
                    parent,
                    false);

            // declaring and typecasting the TextView in the inflated layout:
            TextView tvServerCountry = layout.findViewById(rzr707.vpnclient.R.id.tvServerCountry);
            // set the text using the array:
            tvServerCountry.setText(countries.getCountriesNames()[pos]);

            // declaring and typecasting the ImageView in the inflated layout:
            ImageView img = layout.findViewById(rzr707.vpnclient.R.id.imgServerCountry);
