...
public class CustomVpnService /* renamed from 'VpnService' */ extends android.net.VpnService implements Handler.Callback {
    ...
    public void SendWaitMessage() {
        mHandler.sendEmptyMessage(rzr707.vpnclient.R.string.wait);
    }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (message.what != rzr707.vpnclient.R.string.disconnected) {
    ...
    private void connect(boolean reconnect) throws WolfSSLException {
        ...
        if(!reconnect) {
            updateForegroundNotification(rzr707.vpnclient.R.string.connecting);
            mHandler.sendEmptyMessage(rzr707.vpnclient.R.string.connecting);
        }
    ...
    private void startConnection(final VpnConnection connection) throws WolfSSLException {
        ...
        connection.setOnEstablishListener(new VpnConnection.OnEstablishListener() {
            public void onEstablish(ParcelFileDescriptor tunInterface) {
                ...
                if(!already_show_connect) {
                    mHandler.sendEmptyMessage(rzr707.vpnclient.R.string.connected);
    ...
    private void SetDisconnectMessage(int signal) {
        mHandler.sendEmptyMessage(signal == SIGNAL_SUCCESS_DISCONNECT ||
                                    ...
                                    rzr707.vpnclient.R.string.disconnected :
                                    rzr707.vpnclient.R.string.can_not_connect);
        SendMessage(signal);
    }
    ...
    private void updateForegroundNotification(final int message) {
        ...
        startForeground(1, new Notification.Builder(this)
                .setSmallIcon(rzr707.vpnclient.R.drawable.lock_locked)
